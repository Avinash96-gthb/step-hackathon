 ...
 */
export class InstantSongLookupEngine {
  private songsByIdMap: HashMap<string, Song>;
  private songsByTitleMap: HashMap<string, Song>;
  private songsByArtistMap: HashMap<string, Song[]>;
  private songsCount: number = 0;

  constructor(initialCapacity: number = 100) {
    this.songsByIdMap = new HashMap<string, Song>(initialCapacity);
    this.songsByTitleMap = new HashMap<string, Song>(initialCapacity);
    this.songsByArtistMap = new HashMap<string, Song[]>(initialCapacity);
  }
