...
exports.SongRatingEngine = void 0;
...
class SongRatingEngine {
    constructor() {
        this.ratingTree = new dataStructures_1.BinarySearchTree();
     ...
     */
    getSongsWithMinimumRating(minRating) {
        try {
     ...
     * Space Complexity: O(k) where k is the number of matching songs
     */
    getSongsWithMaximumRating(maxRating) {
        try {
     ...
     * Space Complexity: O(k) where k is the number of matching songs
     */
    getSongsByRatingRange(minRating, maxRating) {
        try {
...
exports.SongRatingEngine = SongRatingEngine;
//# sourceMappingURL=SongRatingEngine.js.map